      ...
      if (this.serverless.service.configValidationMode === 'error') {
        ...
        if (!this.serverless.configurationInput.configValidationMode) {
          this.serverless._logDeprecation(
            ...
            'Starting with the next major, Serverless will throw on configuration errors by default. ' +
              'Adapt to this behavior now by adding "configValidationMode: error" to the service configuration'
          );
        }
      }
    }
