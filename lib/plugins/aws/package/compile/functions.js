      ...
      'initialize': () => {
        if (
          ...
          this.serverless._logDeprecation(
            ...
            'Resolution of lambda version hashes with the "20200924" algorithm is deprecated. It is highly recommend to migrate to new default algorithm. Please see the deprecation documentation for more details about the migration process.'
          );
        }
