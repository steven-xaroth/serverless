...
# Run the local 'serverless' package if it exists in 'node_modules'
...
provider:
  ...
  # optional, if set to 'true', disables default behavior of generating export names for CloudFormation outputs
